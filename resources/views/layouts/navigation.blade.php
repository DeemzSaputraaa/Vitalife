<nav x-data="{ open: false }"
    class="bg-blue-100 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 rounded-bl-lg rounded-br-lg fixed top-0 left-0 right-0 z-50">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <button id="changeLanguageBtn" data-lang="{{ App::getLocale() }}"
