...
<body>
    <section
        class="h-screen bg-white dark:bg-gray-900 relative absolute top-0 left-0 right-0 bottom-0 bg-cover bg-center"
        style="background-image: url('../image/bgspa.jpg');" id="background-section">
        {{-- <section class="h-screen bg-white dark:bg-gray-900 relative  top-0 left-0 right-0 bottom-0" id="background-section"> --}}
            ...
            <nav class="fixed top-4 right-4 flex justify-end rounded-md p-2">
                @if (auth()->user())
                    <a href="{{ route('dashboard') }}"
                        class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white rounded-md">Dashboard</a>
                @else
                    <a href="{{ route('login') }}"
                        class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white rounded-md">Log
                        in</a>
                    <span class="px-3 py-2 text-gray-600">|</span>
                    <a href="{{ route('register') }}"
                        class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white rounded-md">Register</a>
                @endif
            </nav>
