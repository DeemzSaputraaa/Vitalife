...
@section('judul-halaman', 'Create Voucher')
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form
                        action="{{ isset($voucher) ? route('admin.vouchers.update', $voucher) : route('admin.vouchers.store') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="expired_at" id="expired_at"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                value="{{ ($voucher->expired_at ?? old('expired_at')) }}">
                        </div>
                        <div class="mb-4">
