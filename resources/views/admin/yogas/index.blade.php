            ...
            <tbody>
                @forelse ($yogas as $spa)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b">{{ is_array($spa->noHP) ? implode(', ', $spa->noHP) : $spa->noHP }}
                        </td>
                        <td class="py-2 px-4 border-b">
                            {{ is_array($spa->waktuBuka) ? implode(', ', $spa->waktuBuka) : $spa->waktuBuka }}</td>
                        <td class="py-2 px-4 border-b">
